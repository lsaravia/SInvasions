...
vpath_src=../fortify ../canew ../randlib/src ../cml
vpath %.c    $(vpath_src)
vpath %.cpp  $(vpath_src)
vpath %.hpp  $(vpath_src)
vpath %.h    $(vpath_src)

INCLUDE_DIRS=/cpp/cml
LIB_DIRS=
C_DEBUG_FLAGS=-g
C_OPT_FLAGS=
C_WARN_FLAGS=
...
LIBS=grx20
LD_EXTRA_FLAGS=
C_EXTRA_FLAGS=-DGRAPHICS -DNOWRAP
LOCAL_OPT=$(subst ___~~~___, ,$(subst $(notdir $<)___,,$(filter $(notdir\
	$<)___%,$(LOCAL_OPTIONS))))

OBJFILES=BGI.o com.o linpack.o randlib.o SInvasions.o
ALL_OBJFILES=BGI.o com.o linpack.o randlib.o SInvasions.o
LIBRARIES=
SOURCE_NAME=$<
OUTFILE=$@
SPECIAL_CFLAGS=
SPECIAL_LDFLAGS=
PROG_ARGS=parms.dat
SRC_DIRS=../fortify ../canew ../randlib/src ../cml
WUC=
EDITORS=
MAIN_TARGET=sinva.exe
PROJECT_ITEMS=BGI.cc com.c linpack.c randlib.c SInvasions.cpp
DEFAULT_MASK=*.h
RHIDE_BIN_DIR=e:/djgpp/bin
PASCAL_TYPE=GPC
GET_HOME=$(HOME)
...
clean::
	rm -f $(CLEAN_FILES)
DEPS_0= BGI.o com.o linpack.o randlib.o SInvasions.o 
NO_LINK=
